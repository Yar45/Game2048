...
Game::Game(unsigned int fpsLimit, sf::RenderWindow* window) {
	currentFrame = 0;
...
void Game::onKeyboard(const sf::Keyboard::Key& button) {
	if (action == TO_GAME) {
